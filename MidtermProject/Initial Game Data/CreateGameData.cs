...
namespace MidtermProject.Create_Game_Data
{
    class CreateGameData
    {
        ...
        static void Abilities()
        {
            ...
            new Ability{
                Name = "Shield Slam",//8
                Description = "Lower attack for 1 enemy.",
                AOE = false,
                TargetEnemies = true,
                IsPhysical = true,
                Alter_Strength = 5,
            ...
            new Ability{
                ...
                Manacost = 150
                        ...
                        new Ability{
                Name = "Beer Keg",//15
                Description = "Raise the attack of all allies.",
                AOE = true,
                TargetEnemies = false,
                IsPhysical = true,
            ...
            DataAccess.AddMany(InitialAbilities);
        }

        static void HeroNames()
        {
            List<Hero_Name> names = new List<Hero_Name> {
           ...
           new Hero_Name("Hugh Campbell"),
            ...
            DataAccess.AddMany(names);

        }

        static void HeroClasses()
        {
            List<HeroType> herolist = new List<HeroType> {
            ...
            DataAccess.AddMany(herolist);
        }

        static void Enemies()
        {
            List<EnemyType> enlist = new List<EnemyType>
            {
            new EnemyType
                {
