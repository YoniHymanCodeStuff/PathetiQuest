...
namespace ProjectTempUI.Migrations
{
    ...
    [Migration("20211129200628_introtextstuff")]
    partial class introtextstuff
    {
            ...
            modelBuilder.Entity("HeroItem", b =>
                {
                    ...
                    b.HasKey("EquippedItemId", "Owning_HeroId");
            ...
            modelBuilder.Entity("ItemPlayer", b =>
                {
                    ...
                    b.Property<int>("Owning_PlayerId")
                        .HasColumnType("int");

                    b.HasKey("InventoryItemId", "Owning_PlayerId");

                    b.HasIndex("Owning_PlayerId");

                    b.ToTable("Player <-> Inventory Item");
                });
